<?php $__env->startSection('title', 'Add Pharmacy'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           ...
                                           placeholder="Enter complete pharmacy address" required><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       placeholder="Brief description about the pharmacy (optional)"><?php echo e(old('description')); ?></textarea>
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-600 mt-1">
                        All <?php echo e($medicines->count()); ?> medicines from the database will be automatically added to this pharmacy with:
                    </p>
            ...
            <div class="max-h-40 overflow-y-auto border rounded-lg">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-3 py-2 font-medium"><?php echo e($medicine->nama); ?></td>
                            <td class="px-3 py-2"><?php echo e($medicine->kategori); ?></td>
                            <td class="px-3 py-2">Rp <?php echo e(number_format($medicine->harga, 0, ',', '.')); ?></td>
                            <td class="px-3 py-2"><?php echo e($medicine->produsen); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
