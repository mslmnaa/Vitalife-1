<?php $__env->startSection('judul-halaman', 'Account User Management'); ?>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($users->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-purple-400 to-purple-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($users->where('role', 'admin')->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-teal-400 to-teal-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($users->where('role', 'dokter')->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-green-400 to-green-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($users->where('role', 'user')->count()); ?></div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <!-- Add User Button -->
                        <a href="<?php echo e(route('admin.account.create')); ?>"
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-200" id="userTableBody">
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200 user-row" data-name="<?php echo e(strtolower($user->name)); ?>" data-email="<?php echo e(strtolower($user->email)); ?>" data-role="<?php echo e($user->role); ?>">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="relative group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <!-- Delete Button -->
                                            <button type="button"
                                                    onclick="showDeleteModal('<?php echo e($user->id); ?>', '<?php echo e(addslashes($user->name)); ?>')"
