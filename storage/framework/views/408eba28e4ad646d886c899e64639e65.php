...
<div x-data="{ showPassword: false }" class="relative">
    <input <?php echo e($disabled ? 'disabled' : ''); ?> :type="showPassword ? 'text' : 'password'" <?php echo $attributes->merge([
        'class' =>
...
<?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/components/text-inputPW.blade.php ENDPATH**/ ?>