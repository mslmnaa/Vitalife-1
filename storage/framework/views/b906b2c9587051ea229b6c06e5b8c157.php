<?php $__env->startSection('judul-halaman', 'Form Spesialis'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto p-4 bg-white shadow-md rounded-lg">
        ...
        <form action="<?php echo e(route('admin.spesialis.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views\admin\formspesialis.blade.php ENDPATH**/ ?>