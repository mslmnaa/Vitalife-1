                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                <img src="<?php echo e(asset($spesialis->image)); ?>" alt="specialist"
                            ...
                            <div class="flex-1">
                                <h2 class="text-xl font-semibold text-gray-900"><?php echo e($spesialis->nama); ?></h2>
                                <p class="text-blue-600 font-medium"><?php echo e($spesialis->spesialisasi); ?></p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-medium">Rp<?php echo e(number_format($spesialis->harga, 0, ',', '.')); ?></span>
                            </div>
                            
                            <?php if(session('applied_voucher')): ?>
                            <div class="flex justify-between items-center py-2 text-green-600">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                    </svg>
                                    <span>Voucher (<?php echo e(session('applied_voucher')); ?> - <?php echo e(session('discount_percentage')); ?>%)</span>
                                </div>
                                <span class="font-medium">- Rp<?php echo e(number_format(session('discount_amount'), 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="border-t pt-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-xl font-bold text-blue-600">
                                        <?php if(session('applied_voucher')): ?>
                                            Rp<?php echo e(number_format(session('discounted_price'), 0, ',', '.')); ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <?php if(session('applied_voucher')): ?>
                            <div class="flex justify-between items-center p-4 bg-green-50 border border-green-200 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-green-900"><?php echo e(session('applied_voucher')); ?></p>
                                        <p class="text-sm text-green-600"><?php echo e(session('discount_percentage')); ?>% discount applied</p>
                                    </div>
                                </div>
                                <form action="<?php echo e(route('admin.remove.voucher')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="mt-3 p-3 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                            <?php echo e(session('voucher_success')); ?>
                        ...
                        <div class="mt-3 p-3 bg-red-100 border border-red-400 text-red-700 rounded-lg">
                            <?php echo e(session('voucher_error')); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('personalDataForm').addEventListener('submit', function(e) {
            ...
            personalData = {
                specialist_id: <?php echo e($spesialis->id_spesialis); ?>,
...
<?php endif; ?>
<?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/user/spesBayar.blade.php ENDPATH**/ ?>