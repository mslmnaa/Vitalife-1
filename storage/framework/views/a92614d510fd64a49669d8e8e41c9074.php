        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-bold text-xl"><?php echo e($payment->full_name); ?></h3>
                            <p class="text-blue-100 text-sm"><?php echo e($payment->gender); ?>, <?php echo e(\Carbon\Carbon::parse($payment->date_of_birth)->age); ?> tahun</p>
                        </div>
                    </div>
            ...
            <div class="flex-1 p-6 overflow-y-auto bg-gray-50" style="height: 400px;" id="chatMessages">
                <?php $__empty_1 = true; $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="mb-6 flex <?php echo e($chat->sender_id === Auth::id() ? 'justify-end' : 'justify-start'); ?>">
                        <div class="flex items-end max-w-xs lg:max-w-md <?php echo e($chat->sender_id === Auth::id() ? 'flex-row-reverse' : 'flex-row'); ?>">
                            <!-- Avatar -->
                            <div class="flex-shrink-0 <?php echo e($chat->sender_id === Auth::id() ? 'ml-2' : 'mr-2'); ?>">
                                <div class="w-8 h-8 rounded-full flex items-center justify-center <?php echo e($chat->sender_id === Auth::id() ? 'bg-blue-500' : 'bg-gray-400'); ?>">
                                    <i class="fas <?php echo e($chat->sender_id === Auth::id() ? 'fa-user-md' : 'fa-user'); ?> text-white text-xs"></i>
                                </div>
                            </div>
                            
                            <!-- Message Bubble -->
                            <div class="relative px-4 py-3 rounded-2xl <?php echo e($chat->sender_id === Auth::id() ? 'bg-blue-600 text-white rounded-br-md' : 'bg-white text-gray-800 rounded-bl-md shadow-sm border border-gray-200'); ?>">
                                <p class="text-sm leading-relaxed"><?php echo e($chat->message); ?></p>
                                <p class="text-xs mt-2 <?php echo e($chat->sender_id === Auth::id() ? 'text-blue-200' : 'text-gray-500'); ?>">
                                    <?php echo e($chat->created_at->format('H:i')); ?>

                                </p>
                                
                                <!-- Message Tail -->
                                <div class="absolute bottom-0 <?php echo e($chat->sender_id === Auth::id() ? '-right-2' : '-left-2'); ?> w-0 h-0 border-l-8 border-r-8 border-t-8 <?php echo e($chat->sender_id === Auth::id() ? 'border-l-transparent border-r-blue-600 border-t-blue-600' : 'border-r-transparent border-l-white border-t-white'); ?>"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-6 bg-white border-t border-gray-200">
                <form action="<?php echo e(route('doctor.chat.send', $payment->id)); ?>" method="POST" class="flex items-end space-x-3">
                    <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                <div class="bg-red-50 rounded-lg p-4 border-l-4 border-red-400">
                    ...
                    <p class="text-red-700 font-medium"><?php echo e($payment->complaints); ?></p>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-400">
                    ...
                    <p class="text-blue-700 font-medium"><?php echo e($payment->medical_history ?: 'Tidak ada'); ?></p>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium"><?php echo e($payment->phone_number); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium"><?php echo e($payment->address); ?></p>
                        </div>
                    </div>
                </div>
            </div>
