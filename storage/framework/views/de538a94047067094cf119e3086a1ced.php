    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    <strong>Broadcast Driver:</strong> <?php echo e(config('broadcasting.default')); ?><br>
                    <strong>Reverb Host:</strong> <?php echo e(config('broadcasting.connections.reverb.options.host')); ?><br>
                    <strong>Reverb Port:</strong> <?php echo e(config('broadcasting.connections.reverb.options.port')); ?><br>
                    <strong>Reverb Scheme:</strong> <?php echo e(config('broadcasting.connections.reverb.options.scheme')); ?>

                </div>
                <div>
                    <strong>App ID:</strong> <?php echo e(config('broadcasting.connections.reverb.app_id')); ?><br>
                    <strong>App Key:</strong> <?php echo e(config('broadcasting.connections.reverb.key')); ?><br>
...
if (window.Echo && window.Echo.connector && window.Echo.connector.pusher) {
    ...
    log('Trying Echo WebSocket URL: ' + echoWsUrl, 'info');
            ...
            if (typeof window.Echo !== 'undefined') {
                ...
                // Test user channel
                log('Testing user channel: user.<?php echo e(auth()->id()); ?>', 'info');
...
<?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views\debug\reverb.blade.php ENDPATH**/ ?>