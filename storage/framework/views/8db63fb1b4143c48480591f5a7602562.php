    ...
    <div class="p-6">
        <form method="post" action="<?php echo e(route('profile.update.image')); ?>" class="space-y-6" enctype="multipart/form-data">
            ...
            <div id="drop-area" class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center transition-all duration-200 hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 cursor-pointer" onclick="document.getElementById('image').click()">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Drag and drop your image here')); ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?php echo e(__('or click to browse')); ?></p>
            </div>
