            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-4 bg-white border-b border-gray-200">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('chat.index')); ?>" class="text-gray-600 hover:text-indigo-600 mr-4">
                        ...
                        <?php else: ?>
                            <div class="w-10 h-10 rounded-full bg-gray-300 mr-3 flex items-center justify-center">
                                <span class="text-gray-600"><?php echo e(substr($payment->specialist->nama, 0, 1)); ?></span>
                            </div>
                        <?php endif; ?>
                        
                        <div>
                            <h3 class="font-semibold"><?php echo e($isSpecialist ? $payment->full_name : $payment->specialist->nama); ?></h3>
                            <p class="text-sm text-gray-600">
                                <?php echo e($isSpecialist ? 'Patient' : $payment->specialist->spesialisasi); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg h-[calc(100vh-300px)] flex flex-col">
                <div id="chat-messages" class="p-4 flex-1 overflow-y-auto">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="flex mb-4 <?php echo e($isCurrentUserSender ? 'justify-end' : 'justify-start'); ?>">
                                <div class="max-w-[70%] <?php echo e($isCurrentUserSender ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-800'); ?> rounded-lg py-2 px-4">
                                    <p><?php echo e($message->message); ?></p>
                                    <p class="text-xs <?php echo e($isCurrentUserSender ? 'text-indigo-200' : 'text-gray-500'); ?> mt-1">
                ...
                <div class="p-4 border-t">
                    <form id="message-form" class="flex space-x-2">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="payment_id" id="payment-id" value="<?php echo e($payment->id); ?>">
                        <input type="hidden" name="receiver_id" id="receiver-id" value="<?php echo e($isSpecialist ? $payment->user_id : $payment->specialist->user_id); ?>">
                        <input 
                            type="text" 
                            name="message" 
                            id="message-input"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function appendMessage(message) {
                const isCurrentUserSender = message.sender_id === <?php echo e(auth()->id()); ?>;
...
<?php endif; ?><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views\user\chat\show.blade.php ENDPATH**/ ?>