    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-white relative overflow-y-auto">
            ...
            <div class="w-full max-w-md register-card">
                ...
                <!-- Registration Form -->
               <form id="registerForm" method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold hover:underline">Sign in here</a>
                        </p>
                    </div>
                </form>
            </div>
...
</html><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/auth/register.blade.php ENDPATH**/ ?>