<?php $__env->startSection('judul-halaman', 'Voucher Management'); ?>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="bg-gradient-to-r from-green-400 to-green-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($vouchers->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($vouchers->where('is_used', false)->where('expired_at', '>', now())->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-red-400 to-red-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($vouchers->where('expired_at', '<', now())->count()); ?></div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="relative group">
                                                <?php if($voucher->image): ?>
                                                    <img class="h-12 w-20 rounded-xl object-cover shadow-md cursor-pointer" 
                                                        src="<?php echo e(asset($voucher->image)); ?>" 
                                                        alt="<?php echo e($voucher->code); ?>"
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($voucher->code); ?></div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-lg font-bold text-orange-600"><?php echo e($voucher->discount_percentage); ?>%</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($voucher->usage_count); ?> / <?php echo e($voucher->usage_limit ? $voucher->usage_limit : '∞'); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="text-sm text-gray-900">
                                                <?php echo e($voucher->expired_at ? \Carbon\Carbon::parse($voucher->expired_at)->format('d/m/Y') : 'Never'); ?>

                                            </span>
                                            <?php if($voucher->expired_at): ?>
                                                <span class="text-xs text-gray-500">
                                                    <?php echo e(\Carbon\Carbon::parse($voucher->expired_at)->diffForHumans()); ?>
