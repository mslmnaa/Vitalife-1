                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-600">Valid until: <span class="font-semibold text-red-600"><?php echo e(date('d M Y', strtotime($voucher->expired_at))); ?></span></span>
                                <?php else: ?>
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-600">
                                    Used <span class="font-semibold text-blue-600"><?php echo e($voucher->usage_count); ?></span>
