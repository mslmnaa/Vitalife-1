...
<div class="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
   ...
   <div id="services" class="py-16 bg-white reveal">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 animate-fade-in">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Medicines & Pharmacy Services</h2>
            <p class="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">Find quality medicines and trusted pharmacies for your healthcare needs</p>
        </div>
        
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Medicines Section -->
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-blue-200 transform hover:-translate-y-3 hover:scale-105 animate-fade-in-up animation-delay-100">
                <div class="bg-blue-500 w-20 h-20 rounded-full flex items-center justify-center mb-6 mx-auto animate-pulse shadow-lg">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-700 mb-6 leading-relaxed">Discover a comprehensive collection of prescription and over-the-counter medicines. Find detailed information, prices, and availability.</p>
                    
                    <div class="flex flex-wrap justify-center gap-2 mb-6">
                        <span class="bg-blue-200 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Prescription</span>
                        <span class="bg-blue-200 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Over-the-Counter</span>
                        <span class="bg-blue-200 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Supplements</span>
                    </div>
                    
                    <a href="<?php echo e(route('medicines.index')); ?>" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group">
                        <span>Explore Medicines</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2 transform transition-transform group-hover:translate-x-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <!-- Pharmacy Section -->
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-emerald-200 transform hover:-translate-y-3 hover:scale-105 animate-fade-in-up animation-delay-200">
                <div class="bg-emerald-500 w-20 h-20 rounded-full flex items-center justify-center mb-6 mx-auto animate-pulse shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H3m0 0h2M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                </div>
                
                <div class="text-center">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Find Pharmacies</h3>
                    <p class="text-gray-700 mb-6 leading-relaxed">Locate trusted pharmacies near you. Check medicine availability, contact information, and get directions to the nearest pharmacy.</p>
                    
                    <div class="flex flex-wrap justify-center gap-2 mb-6">
                        <span class="bg-emerald-200 text-emerald-800 px-3 py-1 rounded-full text-sm font-medium">Nearby</span>
                        <span class="bg-emerald-200 text-emerald-800 px-3 py-1 rounded-full text-sm font-medium">24/7 Service</span>
                        <span class="bg-emerald-200 text-emerald-800 px-3 py-1 rounded-full text-sm font-medium">Medicine Check</span>
                    </div>
                    
                    <a href="<?php echo e(route('pharmacies.index')); ?>" class="inline-flex items-center bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group">
