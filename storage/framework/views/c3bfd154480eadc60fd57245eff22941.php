                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div class="p-8 lg:p-10">
                        ...
                        <div class="space-y-6 mb-8">
                            ...
                            <div class="flex items-center justify-between p-4 bg-white bg-opacity-5 rounded-xl border border-white border-opacity-10">
                                <span class="text-gray-800 font-medium">Produsen</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-6 border border-white border-opacity-20">
                    <div class="flex items-center mb-4">
                        ...
                        <h4 class="text-gray-800 font-semibold">Komposisi</h4>
                    </div>
                    <p class="text-gray-700 text-sm">Informasi lengkap tentang bahan aktif dan komposisi obat yang terkandung.</p>
                </div>
                ...
                <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-6 border border-white border-opacity-20">
                    <div class="flex items-center mb-4">
                        ...
                        <h4 class="text-gray-800 font-semibold">Indikasi</h4>
                    </div>
                    <p class="text-gray-700 text-sm">Kegunaan dan indikasi medis untuk penggunaan obat ini sesuai petunjuk dokter.</p>
                </div>
                ...
                <div class="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-6 border border-white border-opacity-20">
                    <div class="flex items-center mb-4">
                        ...
                        <h4 class="text-gray-800 font-semibold">Efek Samping</h4>
                    </div>
                    <p class="text-gray-700 text-sm">Kemungkinan efek samping dan peringatan penting dalam penggunaan obat.</p>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/user/medicines/show.blade.php ENDPATH**/ ?>