...
<body class="bg-gray-50 font-sans antialiased">
    <div class="min-h-screen flex" x-data="{ 
            ...
            isOnline: <?php echo e(auth()->user()->spesialis->is_online ? 'true' : 'false'); ?>,
            toggleLoading: false
         }" 
         x-init="
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center justify-between">
                            ...
                            <form method="POST" action="<?php echo e(route('doctor.doctor.toggleOnline')); ?>"
...
</html><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/layouts/doctor.blade.php ENDPATH**/ ?>