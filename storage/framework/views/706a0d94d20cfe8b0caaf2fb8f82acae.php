        ...
        <main class="flex-1 p-8">
            <header class="flex justify-between items-center mb-8">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold ml-2"><?php echo $__env->yieldContent('judul-halaman', 'Dashboard'); ?></h1>
                </div>
...
<?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views\appadmin.blade.php ENDPATH**/ ?>