<?php $__env->startSection('judul-halaman', 'Daftar Spesialis'); ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($nama); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 max-w-xs truncate" title="<?php echo e(is_array($spesialis->alamat) ? implode(', ', $spesialis->alamat) : $spesialis->alamat); ?>">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 max-w-xs truncate" title="<?php echo e(is_array($spesialis->tempatTugas) ? implode(', ', $spesialis->tempatTugas) : $spesialis->tempatTugas); ?>">
