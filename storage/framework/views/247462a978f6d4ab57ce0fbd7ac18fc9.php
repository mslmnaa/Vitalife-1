                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($spesialisis->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-green-400 to-green-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($spesialisis->unique('spesialisasi')->count()); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-purple-400 to-purple-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold"><?php echo e($spesialisis->unique('tempatTugas')->count()); ?></div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            <form method="GET" class="flex">
                                ...
                                <select name="spesialisasi" class="border-t border-b border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    ...
                                    <?php $__currentLoopData = $spesialisis->unique('spesialisasi'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spesialis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($spesialis->spesialisasi); ?>" <?php echo e(request('spesialisasi') == $spesialis->spesialisasi ? 'selected' : ''); ?>>
                        ...
                        <a href="<?php echo e(route('admin.spesialisis.create')); ?>"
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">
                                                    <?php echo e(is_array($spesialis->nama) ? implode(', ', $spesialis->nama) : $spesialis->nama); ?>

                                                </div>
                                                <div class="text-xs text-gray-500">
                                                    <?php echo e(is_array($spesialis->alamat) ? Str::limit(implode(', ', $spesialis->alamat), 30) : Str::limit($spesialis->alamat, 30)); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <!-- Delete Button -->
                                            <button type="button"
                                                    onclick="showDeleteModal('<?php echo e($spesialis->id_spesialis); ?>', '<?php echo e(addslashes(is_array($spesialis->nama) ? implode(', ', $spesialis->nama) : $spesialis->nama)); ?>')"
