                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        <div>
                            ...
                            <input type="number" id="max_price" name="max_price"
                                class="block w-full rounded-xl border-0 py-4 px-4 text-gray-900 ring-1 ring-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-green-500 focus:outline-none transition-all duration-200"
                                placeholder="999999999" value="<?php echo e(request('max_price')); ?>" />
                        </div>
                        <div>
                            <button type="submit" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
                    ...
                    <form id="locationForm" action="<?php echo e(route('spesialis')); ?>" method="GET" class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center p-3 rounded-xl hover:bg-gray-50 cursor-pointer transition-all duration-200 group">
                                <input type="radio" name="location" value="<?php echo e($location); ?>" 
                                    class="sr-only" onchange="this.form.submit()"
                                    <?php echo e(request('location') == $location ? 'checked' : ''); ?>>
                                <div class="flex items-center w-full">
                                    <i class="<?php echo e($icon); ?> mr-3 text-blue-600 group-hover:text-indigo-600 transition-colors duration-200"></i>
                                    <span class="text-gray-700 font-medium group-hover:text-gray-900 flex-grow"><?php echo e($location); ?></span>
                                    <div class="w-4 h-4 border-2 border-gray-300 rounded-full flex items-center justify-center group-hover:border-blue-500 transition-colors duration-200">
                                        <?php if(request('location') == $location): ?>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1"><?php echo e(count($spesLihat)); ?> specialists found</p>
                    </div>
                </div>

                
                <div class="space-y-6">
                    <?php $__empty_1 = true; $__currentLoopData = $spesLihat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spesialis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-8">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 overflow-hidden ring-4 ring-white shadow-lg">
                                        <img src="<?php echo e(asset($spesialis->image)); ?>" alt="<?php echo e($spesialis->nama); ?>" 
                                ...
                                <div class="flex-grow min-w-0">
                                    <div class="mb-4">
                                        <h3 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($spesialis->nama); ?></h3>
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                                                <i class="fas fa-stethoscope mr-1"></i><?php echo e($spesialis->Anatomy); ?>

                                            </span>
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                                                <i class="fas fa-user-md mr-1"></i><?php echo e($spesialis->spesialisasi); ?>
                                    ...
                                    <div class="space-y-2 text-gray-600">
                                        <div class="flex items-center">
                                            ...
                                            <span class="font-medium"><?php echo e($spesialis->tempatTugas); ?></span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-map-marker-alt w-5 text-gray-400 mr-3"></i>
                                            <span><?php echo e($spesialis->alamat); ?></span>
                                        </div>
                                    </div>
                                </div>
...
<?php endif; ?><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views\user\spesialis.blade.php ENDPATH**/ ?>