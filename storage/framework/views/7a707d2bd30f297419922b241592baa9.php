...
<head>
    ...
    <title><?php echo e(config('app.name', 'Vitalife')); ?> - Login</title>
            ...
            <div class="relative z-20 flex flex-col justify-center px-12 text-white">
                <div class="max-w-md">
                    ...
                    <div class="mt-12">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="group inline-flex items-center gap-2 border-2 border-white/30 text-white py-3 px-6 rounded-xl hover:bg-white hover:text-blue-800 transition-all duration-300 font-medium backdrop-blur-sm bg-white/10">
                            <span>SIGN UP</span>
                ...
                <form id="loginForm" method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            required 
                            autofocus
                            class="input-focus w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500 <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                name="password" 
                                required 
                                class="input-focus w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-input <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline">Forgot password?</a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="w-full">
                        <a href="<?php echo e(url('auth/google')); ?>" class="w-full flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold hover:underline">Sign up now</a>
                        </p>
                    </div>
                </form>
            </div>
...
</html><?php /**PATH D:\Coding\Project 4 matklul\Vitalife-1\resources\views/auth/login.blade.php ENDPATH**/ ?>