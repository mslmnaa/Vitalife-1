            ...
            <div class="login-card">
                ...
                <form id="loginForm" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="Masukkan email Anda" value="<?php echo e(old('email')); ?>" required autofocus>
                    ...
                    <div class="social-login">
                        <a href="<?php echo e(url('auth/google')); ?>" class="social-btn">
                        ...
                        <a href="<?php echo e(url('auth/facebook')); ?>" class="social-btn">
