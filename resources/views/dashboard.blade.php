                ...
                <div class="space-y-10 text-center lg:text-left">
                    ...
                    <div class="space-y-6 animate-fade-in-up animation-delay-200">
                        <h1 class="text-6xl lg:text-8xl font-black leading-tight tracking-tight">
                            ...
                            <br>
                            {{-- <span
                                class="bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent animate-gradient-x">
                                Our Priority
                            </span> --}}
                        </h1>
                ...
                @foreach($specializations as $index => $spec)
                    <a href="{{ route('spesialisFilter') }}?spesialisasi={{ $spec['name'] }}"
                        ...
                        <div class="p-6 flex flex-col items-center text-center">
                            <div
                                class="bg-{{ $spec['color'] }}-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 animate-pulse">
                        ...
                        @foreach ($vouchers as $voucher)
                            <div class="w-1/3 flex-shrink-0 px-3 animate-fade-in"
                                ...
                                <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 hover:rotate-1"
                                    ...
                                    <img class="w-full h-48 object-cover" src="{{ asset($voucher->image) }}"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="md:w-2/3 animate-fade-in-left">
                    ...
                    <p class="text-blue-100 text-lg">Consult your health issues with the best specialists anytime,
                        anywhere.</p>
                </div>
                <div class="md:w-1/3 flex justify-center md:justify-end animate-fade-in-right">
                    <a href="#spesialis"
                        class="px-8 py-4 bg-white hover:bg-gray-100 text-blue-600 font-medium rounded-lg shadow-lg transform transition duration-300 hover:scale-105 text-center animate-pulse">
                        Find a Specialist
                    </a>
                </div>
            </div>
