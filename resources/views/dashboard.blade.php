        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-blue-200 transform hover:-translate-y-3 hover:scale-105 animate-fade-in-up animation-delay-100">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('medicines.index') }}" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-emerald-200 transform hover:-translate-y-3 hover:scale-105 animate-fade-in-up animation-delay-200">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('pharmacies.index') }}" class="inline-flex items-center bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group">
