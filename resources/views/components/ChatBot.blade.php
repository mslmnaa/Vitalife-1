...
<div id="restart-modal" class="modal theme-auto" aria-hidden="true" role="dialog" aria-labelledby="restart-modal-title">
    <div class="modal-content">
        {{-- <h3 id="restart-modal-title" class="text-lg font-semibold text-gray-900 theme-auto mb-2">Restart Chat</h3>
        <p class="text-sm text-gray-600 theme-auto">Are you sure you want to restart this conversation? This will clear all current messages.</p>
        <div class="modal-buttons">
            <button id="cancel-restart" class="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition-colors theme-auto focus:outline-none focus:ring-2 focus:ring-gray-500">
                Cancel
            </button>
            <button id="confirm-restart" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500">
                Restart
            </button>
        </div> --}}
    </div>
