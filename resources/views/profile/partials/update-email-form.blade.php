<section class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
    ...
    <div class="p-6">
        <form method="post" action="{{ route('profile.update.email') }}" class="space-y-6">
            ...
            <!-- Current Email field -->
            <div class="space-y-2">
                <x-input-label for="current_email" :value="__('Current Email')" class="text-sm font-medium text-gray-700" />
                <div class="relative">
                    ...
                    <x-text-input id="current_email" name="current_email" type="email" 
                        class="pl-10 block w-full rounded-lg border-gray-300 bg-gray-100 text-gray-600 cursor-not-allowed" 
            ...
            <!-- New Email field -->
            <div class="space-y-2">
                <x-input-label for="new_email" :value="__('New Email')" class="text-sm font-medium text-gray-700" />
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path>
            ...
            <div class="space-y-2">
                <x-input-label for="new_email_confirmation" :value="__('Confirm New Email')" class="text-sm font-medium text-gray-700" />
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
