                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    @if($voucher->expired_at)
                                        <span class="text-gray-600">Berlaku hingga: <span class="font-semibold text-red-600">{{ date('d M Y', strtotime($voucher->expired_at)) }}</span></span>
                                    @else
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-600">
                                        Digunakan <span class="font-semibold text-blue-600">{{ $voucher->usage_count }}</span>
