            ...
            <div class="w-full max-w-md register-card">
                ...
                <form id="registerForm" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ url('auth/googlee') }}" class="flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors group">
