        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex space-x-2">
                    ...
                    <form action="{{ route('admin.medicines.destroy', $medicine->id_medicine) }}" method="POST" class="inline" 
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="md:flex">
                    ...
                    <div class="md:w-1/3">
                        @if($medicine->image)
                            <img src="{{ asset($medicine->image) }}" alt="{{ $medicine->nama }}" 
                    ...
                    <div class="md:w-2/3 p-6">
                        <div class="mb-4">
                            <h2 class="text-3xl font-bold text-gray-900 mb-2">{{ $medicine->nama }}</h2>
                            ...
                            <div>
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        ...
                                        <dd class="text-lg font-bold text-green-600">{{ $medicine->formatted_price }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">Stock</dt>
                                        <dd class="text-sm text-gray-900">{{ $medicine->stok }} units</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">Manufacturer</dt>
                                        <dd class="text-sm text-gray-900">{{ $medicine->produsen }}</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div>
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        ...
                                        <dd class="text-sm text-gray-900">{{ $medicine->tanggal_kadaluarsa->format('d F Y') }}</dd>
                                    </div>
                                    <div>
                                        ...
                                        <dd class="text-sm text-gray-900">
                                            ...
                                            @if($daysUntilExpiry < 0)
                                                <span class="text-red-600 font-semibold">Expired {{ abs($daysUntilExpiry) }} days ago</span>
                                            @elseif($daysUntilExpiry == 0)
                                                <span class="text-red-600 font-semibold">Expires today</span>
                                            @else
                                                <span class="{{ $daysUntilExpiry <= 30 ? 'text-yellow-600' : 'text-green-600' }} font-semibold">
                                    ...
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">Added Date</dt>
                                            {{ optional($medicine->created_at)->format('d F Y, H:i') ?? 'Belum ada' }}
                                    </div>
                                </dl>
                            </div>
                        </div>
            ...
            <div class="mt-6 bg-gray-50 rounded-lg p-4">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    @if($medicine->expiry_status == 'Akan Kadaluarsa')
