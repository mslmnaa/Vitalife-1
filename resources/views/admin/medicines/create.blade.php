                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="kategori" id="kategori" 
                                ...
                                <option value="Obat Batuk" {{ old('kategori') == 'Obat Batuk' ? 'selected' : '' }}>Obat Batuk</option>
                                <option value="Obat Demam" {{ old('kategori') == 'Obat Demam' ? 'selected' : '' }}>Obat Demam</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="produsen" id="produsen" value="{{ old('produsen') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Enter medicine description, usage, dosage, etc." required>{{ old('deskripsi') }}</textarea>
                        </div>
