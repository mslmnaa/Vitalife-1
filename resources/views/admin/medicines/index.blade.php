                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="bg-gradient-to-r from-green-400 to-green-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $medicines->count() }}</div>
                        ...
                        <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $medicines->where('stok', '<=', 10)->count() }}</div>
                        ...
                        <div class="bg-gradient-to-r from-red-400 to-red-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $medicines->filter(function($m) { return $m->tanggal_kadaluarsa->isPast(); })->count() }}</div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-gray-900">{{ $medicine->nama }}</div>
                                                <div class="text-xs text-gray-500">ID: {{ $medicine->id_medicine }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-bold text-green-600">{{ $medicine->formatted_price }}</div>
                                    </td>
                                    <td class="px-6 py-4">
...
<!-- Delete Button -->
<button type="button"
        onclick="showDeleteModal('{{ $medicine->id_medicine }}', '{{ addslashes($medicine->nama) }}')"
