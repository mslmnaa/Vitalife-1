        ...
        <div class="p-6">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                        <div class="flex items-center">
                                            <span class="mr-3">{{ $pharmacy->whatsapp }}</span>
                                            <a href="{{ $pharmacy->whatsapp_link }}" target="_blank" 
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                        @if($pharmacy->latitude && $pharmacy->longitude)
                                            <div class="flex items-center">
                                                <span class="mr-3">{{ $pharmacy->latitude }}, {{ $pharmacy->longitude }}</span>
            ...
            <div class="mt-8">
                ...
                @if($medicinesByCategory->count() > 0)
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-blue-600 mb-3">{{ $category }}</h3>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-500">{{ $medicine->produsen }}</div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $medicine->pivot->stock > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                {{ $medicine->pivot->stock }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            @if($medicine->pivot->price)
                                                <span class="font-medium">Rp {{ number_format($medicine->pivot->price, 0, ',', '.') }}</span>
                                            @else
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900">{{ $medicine->pivot->notes ?: '-' }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
