...
@section('judul-halaman', 'Pharmacy Management')
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="bg-gradient-to-r from-green-400 to-green-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $pharmacies->total() }}</div>
                        ...
                        <div class="bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $pharmacies->where('is_active', true)->count() }}</div>
                        ...
                        <div class="bg-gradient-to-r from-purple-400 to-purple-600 rounded-lg p-4 text-white min-w-24">
                            <div class="text-2xl font-bold">{{ $pharmacies->sum(function($p) { return $p->medicines->count(); }) }}</div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="relative group">
                                                @if($pharmacy->image)
                                                    <img class="h-12 w-12 rounded-xl object-cover shadow-md cursor-pointer" 
                                                         ...
                                                         alt="{{ $pharmacy->name }}"
                                                         onclick="showImageModal('{{ $pharmacy->image_url }}', '{{ $pharmacy->name }}')">
                                                @else
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-gray-900">{{ $pharmacy->name }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500">WA: {{ $pharmacy->whatsapp }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ Str::limit($pharmacy->address, 50) }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-medium text-gray-900">{{ $pharmacy->medicines->count() }} medicines</span>
