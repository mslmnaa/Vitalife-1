        ...
        <div class="flex-grow overflow-y-auto py-4 scrollbar-hide">
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('admin.dashboard') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('admin.dashboard') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">Overview & Analytics</p>
                    </div>
                ...
                <a href="{{ route('medicines.index') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('medicines.index*') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('medicines.index*') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">Manage medications</p>
                    </div>
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fa-solid fa-chevron-right text-gray-400 text-sm"></i>
                    </div>
                ...
                <a href="{{ route('admin.pharmacies.index') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('admin.pharmacies.*') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('admin.pharmacies.*') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">Manage pharmacies</p>
                    </div>
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fa-solid fa-chevron-right text-gray-400 text-sm"></i>
                    </div>
                ...
                <a href="{{ route('admin.spesialisis.index') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('admin.spesialisis.index') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('admin.spesialisis.index') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">Medical specialists</p>
                    </div>
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fa-solid fa-chevron-right text-gray-400 text-sm"></i>
                    </div>
                ...
                <a href="{{ route('admin.accountuser') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('admin.accountuser') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('admin.accountuser') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">User management</p>
                    </div>
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fa-solid fa-chevron-right text-gray-400 text-sm"></i>
                    </div>
                ...
                <a href="{{ route('admin.vouchers.index') }}"
                    class="nav-link p-4 rounded-xl flex items-center {{ Request::routeIs('admin.vouchers.index') ? 'active text-gray-800' : 'text-gray-300 hover:text-white hover:bg-gray-700/50' }} group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs {{ Request::routeIs('admin.vouchers.index') ? 'text-gray-500' : 'text-gray-400' }} mt-0.5">Discount management</p>
                    </div>
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                        <i class="fa-solid fa-chevron-right text-gray-400 text-sm"></i>
                    </div>
